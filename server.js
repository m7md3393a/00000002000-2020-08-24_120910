...
client.login("NzQxMTM2ODg5ODg4ODk5MTc0.XyzLhA.TJo4t4BQX-_BlSCYefskPn2ICI8");
...
client.on("ready", () => {
  client.user.setActivity(`!uptime -->!u<--| URL يتم دعم عناوين `)//// هنا حالت البوت
...
client.on("message", message => {
  ...
  fetch(link).then(() => {
    ...
    message.reply(`:656834785834041345:`)
